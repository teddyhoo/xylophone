...
@synthesize pointCopy;
DollarPGestureRecognizer *evalStroke;
...
- (void)endTouches:(NSSet *)touches {
    for (UITouch *touch in touches) {
        ...
        [stroke setColor:[UIColor blueColor]];
...
- (void)drawStroke:(Stroke *)stroke
    ...
    pointCopy = [NSValue valueWithCGPoint:point];
    
    CGContextFillRect(context, CGRectMake(point.x - 5, point.y - 5, 5, 5));
